...
2. **Re-skin ekranów aplikacji** (≈&nbsp;2–3 dni). Dashboard, Klienci, Farmy, Inspekcje, Turbiny — zastąpienie hard-coded `blue-*`/`gray-*` klas nowymi tokenami. Tokeny są w&nbsp;miejscu, reskin to&nbsp;praca mechaniczna.
