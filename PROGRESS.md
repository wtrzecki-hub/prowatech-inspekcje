...
_Ostatnia aktualizacja: 2026-04-24 — **Redesign krok 4 — re-skin protokołu PDF/DOCX wdrożony.** Paleta graphite/brand, color-coding ocen sev-1..5 i pilności I-IV, typografia nagłówków 11pt uppercase z kerningiem. Logo bez zmian (decyzja klienta). Single source of truth: `src/lib/design/protocol-tokens.ts`._
