...
_Ostatnia aktualizacja: 2026-04-24 — **Redesign krok 3 Dashboard + follow-up fixes.** Nowe komponenty (sparkline / kalendarz 14d / rozkład ocen) + naprawa 4 starych bugów w StatsCards/RecentInspections/AlertsPanel (brak filtra `is_deleted`, błędne pole `completed_at`). Dashboard w pełni spójny, wartości zweryfikowane SQL-em._
