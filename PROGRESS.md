...
**Roadmapa uwag Artura — 6 z 7 punktów DONE (2026-04-27).** Patrz nagłówek pliku dla pełnego kondensatu. Pozostaje:
...
- **Uzupełnianie EW dla 425 turbin** — można robić stopniowo przez Edytuj turbinę w UI (po commicie `18483f9` jest wreszcie taka możliwość). Opcjonalnie batch SQL gdyby Waldek miał gotowe mapowanie farma → numer EW w jakimś arkuszu.
