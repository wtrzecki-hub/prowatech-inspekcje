...
_Ostatnia aktualizacja: 2026-04-24 — **Redesign krok 5 — Turbina · detail redesign wdrożony.** Dark graphite hero z kodem turbiny (Mono) + chipy (aktywne zalecenia, licznik do przeglądu). 5 tabs (Przegląd / Historia inspekcji / Zalecenia / Zdjęcia / Certyfikaty). Wykres oceny w czasie (inline SVG), karty KPI „Ostatnia kontrola" i „Najbliższe przeglądy", tabela historii inspekcji z PDF/DOCX, lista zaleceń z urgency color-codingiem, grid zdjęć z `inspection_photos`, lista certyfikatów zespołu (UDT/SEP/GWO/Izba) z expiry countdown._
